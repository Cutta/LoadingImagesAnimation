...
public class LoadingImagesView extends LinearLayout {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        totalDuration = array.getInt(R.styleable.LoadingImagesView_duration, totalDuration);
        dividerColor = array.getColor(R.styleable.LoadingImagesView_dividerColor, getResources().getColor(R.color.default_divider_color));
        backgroundColor = array.getColor(R.styleable.LoadingImagesView_backgroundColor, getResources().getColor(R.color.default_background_color));
